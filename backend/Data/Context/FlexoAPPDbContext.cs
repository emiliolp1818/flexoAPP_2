...
{
    /// <summary>
    /// Contexto de base de datos para FlexoAPP - PostgreSQL Edition
    /// Maneja todas las entidades y configuraciones de la base de datos PostgreSQL
    /// </summary>
    public class FlexoAPPDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MachineProgram>(entity =>
            {
                ...
                // PostgreSQL: jsonb en lugar de JSON
                entity.Property(e => e.Colores).IsRequired().HasColumnType("jsonb");
            ...
            modelBuilder.Entity<Maquina>(entity =>
            {
                ...
                entity.Property(e => e.NumeroMaquina).IsRequired();
                entity.Property(e => e.Articulo).IsRequired().HasMaxLength(50);
                entity.Property(e => e.OtSap).IsRequired().HasMaxLength(50);
                entity.Property(e => e.Cliente).IsRequired().HasMaxLength(200);
                entity.Property(e => e.Referencia).HasMaxLength(100);
                entity.Property(e => e.Td).HasMaxLength(10);
                entity.Property(e => e.NumeroColores).IsRequired();
                
                // PostgreSQL: jsonb en lugar de JSON
                entity.Property(e => e.Colores).IsRequired().HasColumnType("jsonb");
                
                entity.Property(e => e.Kilos).IsRequired().HasColumnType("DECIMAL(10,2)");
                entity.Property(e => e.FechaTintaEnMaquina).IsRequired();
                entity.Property(e => e.Sustrato).IsRequired().HasMaxLength(100);
                entity.Property(e => e.Estado).IsRequired().HasMaxLength(20).HasDefaultValue("LISTO");
                entity.Property(e => e.Observaciones).HasMaxLength(1000);
                entity.Property(e => e.LastActionBy).HasMaxLength(100);
