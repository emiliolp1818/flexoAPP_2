...
namespace FlexoAPP.API.Data.Context
{
    ...
    public class FlexoAPPDbContext : DbContext
    {
        ...
        public DbSet<CodTinta> CodTintas { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Maquina>(entity =>
            {
                ...
                entity.Property(e => e.OrdenExcel)
                    .HasColumnName("orden_excel")
                    .HasDefaultValue(0);
            ...
            // Configuración para CodTinta
            modelBuilder.Entity<CodTinta>(entity =>
            {
                entity.ToTable("cod_tintas");
                entity.HasKey(e => e.Id);

                entity.Property(e => e.Articulo).IsRequired().HasMaxLength(50);
                entity.Property(e => e.Descripcion).HasMaxLength(200);
                entity.Property(e => e.Carpeta).HasMaxLength(100);
                entity.Property(e => e.Estante).HasMaxLength(100);
                entity.Property(e => e.LineaTinta).HasMaxLength(100).HasColumnName("linea_tinta");
                entity.Property(e => e.ColoresData).IsRequired().HasColumnType("JSON");
            ...
            // Configuración para PantoneColor
            modelBuilder.Entity<PantoneColor>(entity =>
            {
                entity.ToTable("pantone_colors");
                entity.HasKey(e => e.Id);

                entity.Property(e => e.Code).IsRequired().HasMaxLength(50);
                entity.Property(e => e.Name).IsRequired().HasMaxLength(100);
                entity.Property(e => e.DisplayName).IsRequired().HasMaxLength(100);
                entity.Property(e => e.Hex).IsRequired().HasMaxLength(10);
                entity.Property(e => e.Category).IsRequired().HasMaxLength(50);
                entity.Property(e => e.ColorType).IsRequired().HasMaxLength(20);

                entity.Property(e => e.CreatedAt).HasColumnType("TIMESTAMP").HasDefaultValueSql("CURRENT_TIMESTAMP");
                entity.Property(e => e.UpdatedAt).HasColumnType("TIMESTAMP").HasDefaultValueSql("CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP");

                entity.HasIndex(e => e.Code);
                entity.HasIndex(e => e.ColorType);
                entity.HasIndex(e => e.Category);
            });
        }
    }
