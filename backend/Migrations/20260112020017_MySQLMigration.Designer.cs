...
namespace FlexoAPP.API.Migrations
{
    ...
    [Migration("20260112020017_MySQLMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlexoAPP.API.Models.Entities.Documento", b =>
                {
                    ...
                    b.Property<int>("NumeroDescargas")
                        .HasColumnType("int")
                        .HasColumnName("NumeroDescargas");

                    b.Property<int>("NumeroVistas")
                        .HasColumnType("int")
                        .HasColumnName("NumeroVistas");

                    b.Property<string>("PalabrasClave")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)")
                        .HasColumnName("PalabrasClave");
                    ...
                    b.Property<string>("TamanoFormateado")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)")
                        .HasColumnName("TamanoFormateado");
            ...
            modelBuilder.Entity("flexoAPP.Models.SystemConfig", b =>
                {
            ...
            modelBuilder.Entity("FlexoAPP.API.Models.Entities.User", b =>
                {
                    b.Navigation("CreatedMaquinas");

                    b.Navigation("UpdatedMaquinas");
                });
