    ...
    public class ReportsController : ControllerBase
    {
            ...
            [FromQuery] bool sortDescending = true)
        {
            try
            {
                ...
                _logger.LogInformation("📊 Solicitud de actividades paginadas - Página {Page}, Usuario {UserId}, Módulo {Module}", 
                    page, userId, module);
            ...
            [FromQuery] DateTime? endDate = null)
        {
            try
            {
                ...
                _logger.LogInformation("📊 Solicitud de estadísticas por módulo");
