...
namespace FlexoAPP.API.Models.Entities
{
    ...
    public class Maquina
    {
        ...
        [Required]
        [Range(0, 10, ErrorMessage = "El número de colores debe estar entre 0 y 10")]
        ...
        [Range(0, 9999999.999, ErrorMessage = "Los kilos deben estar entre 0 y 9999999.999")]
        public decimal Kilos { get; set; } = 0m;
        ...
        /// <summary>
        /// Orden de importación del Excel. Se usa para mantener el orden original del archivo.
        /// </summary>
        [Column("orden_excel")]
        public int OrdenExcel { get; set; } = 0;
