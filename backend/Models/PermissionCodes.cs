namespace FlexoAPP.API.Models
{
    ...
    public static class PermissionCodes
    {
        ...
        // Permisos de Diseño
        public const string DESIGN_CREATE = "design.create";
        public const string DESIGN_EDIT = "design.edit";
        public const string DESIGN_DELETE = "design.delete";
        public const string DESIGN_IMPORT = "design.import";
        public const string DESIGN_EXPORT = "design.export";
