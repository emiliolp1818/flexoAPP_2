...
export const environment = {
  ...
  apiUrl: 'http://192.168.1.28:7003/api',             // URL principal del API backend - FIJA para red local
  socketUrl: 'http://192.168.1.28:7003',              // URL para conexiones WebSocket - FIJA para red local
  fallbackUrls: [                                      // URLs de respaldo en caso de fallo de conexión principal
    'http://192.168.1.28:7003/api',                   // URL principal repetida como primer fallback
  ...
  imageBaseUrl: 'http://192.168.1.28:7003',          // URL base para imágenes - FIJA para acceso de red
  ...
  alternativeUrls: [                                   // URLs adicionales para diferentes configuraciones de red
    'http://192.168.1.28:7003/api',                   // Red clase C estándar (192.168.1.x)
    'http://192.168.0.28:7003/api',                   // Red clase C alternativa (192.168.0.x)
    'http://10.0.0.28:7003/api'                       // Red clase A privada (10.x.x.x)
  ]
};
