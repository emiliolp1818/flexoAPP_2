...
interface CodTintaRecord {
  ...
  createdAt?: Date;
  updatedAt?: Date;
  expanded?: boolean; // Estado de expansión de la fila
}
...
export class DesignComponent implements OnInit, OnDestroy {
  ...
  codTintasColumns: string[] = ['expand', 'articulo', 'descripcion', 'colores', 'codTintas', 'cobertura', 'codAnilox', 'acciones'];
...
¿Estás COMPLETAMENTE SEGURO de continuar?`;
  ...
  getPantoneColor(colorName: string): PantoneColor {
    ...
    try {
      ...
      // console.log('🎨 Color obtenido:', colorName, '→', color.hex); // Log deshabilitado para evitar spam
      return color;
    } catch (error) {
  ...
  openCreateCodTintaDialog() {
    import('./create-cod-tinta-dialog/create-cod-tinta-dialog.component').then(m => {
