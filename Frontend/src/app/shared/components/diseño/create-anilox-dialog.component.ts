        ...
        <form [formGroup]="aniloxForm" class="anilox-form">
          ...
          <div class="form-row">
            <mat-form-field appearance="outline" class="half-width">
              ...
              <input matInput formControlName="factorEficiencia" placeholder="Ej: 35" type="number" step="0.01" min="0" max="100">
              <mat-icon matSuffix>speed</mat-icon>
              <mat-hint>Valor por defecto: 35%</mat-hint>
...
export class CreateAniloxDialogComponent {
  ...
  constructor() {
    this.aniloxForm = this.fb.group({
      ...
      factorEficiencia: [35.00, [Validators.min(0), Validators.max(100)]],
